...
export default function IPQueryForm() {
  ...
  const handleInputChangeForVanishInput = (e: React.ChangeEvent<HTMLInputElement>) => {
      ...
      >
        ...
        >
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.98 }}
            className="relative z-10 flex items-center space-x-2 px-4 py-2.5 text-sm bg-gradient-to-r from-blue-50 to-purple-50 dark:from-blue-900/20 dark:to-purple-900/20 rounded-full transition-all duration-200 border border-[rgb(var(--color-border))]"
          >
        ...
        >
          ...
          <motion.button
            ...
            whileHover={{ scale: 1.02 }}
            whileTap={{ scale: 0.98 }}
            className="relative z-10 flex items-center space-x-2 px-4 py-2.5 text-sm bg-blue-50 dark:bg-blue-900/20 rounded-full transition-all duration-200 border border-blue-200 dark:border-blue-700"
          >
        ...
        >
          ...
          <motion.button
            ...
            whileHover={{ scale: 1.02 }}
            whileTap={{ scale: 0.98 }}
            className="relative z-10 flex items-center space-x-2 px-4 py-2.5 text-sm bg-purple-50 dark:bg-purple-900/20 rounded-full transition-all duration-200 border border-purple-200 dark:border-purple-700"
          >
            <div className="flex items-center space-x-1.5">
