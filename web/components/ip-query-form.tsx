...
export default function IPQueryForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const encodedIP = detectIPVersion(trimmedValue) === "IPv6"
      ...
      : trimmedValue;
    window.history.pushState(null, "", `/${encodedIP}`);
    ...
    >
      ...
      >
        ...
        >
          ...
          <motion.button
            onClick={() => { window.history.pushState(null, "", "/8.8.8.8"); executeQuery("8.8.8.8"); }}
            whileHover={{ scale: 1.02 }}
            whileTap={{ scale: 0.98 }}
        ...
        >
          ...
          <motion.button
            onClick={() => { window.history.pushState(null, "", "/" + encodeURIComponent("2001:4860:4860::8888")); executeQuery("2001:4860:4860::8888"); }}
            whileHover={{ scale: 1.02 }}
            whileTap={{ scale: 0.98 }}
